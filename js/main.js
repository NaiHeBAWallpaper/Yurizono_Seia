 ...
 * @Date: 2025-07-08 18:09:44
 * @LastEditors: NaiHe 2794096231@qq.com
 * @LastEditTime: 2025-07-13 22:27:26
 * @FilePath: \myprojects\index28\js\main.js
 * @Description: 
 * 
...
const AUDIO_DETAIL = [
	...
	},
	{
		...
		dialog: {
			...
			English: [
				"Nothing to apologize for. Surprises is what enriches a world.",
				"One could say, I have longed for one as well."
			],
			Chinese: [
				"无需道歉，惊讶能令世界更加饱满。",
				"不如说，我还一直期待着它。"
	...
	},
	{
		...
		dialog: {
			...
			English: [
				"But, I never..",
				"Thought we would be exchanging gazes like this."
			],
			Chinese: [
				"不过，令我意外的是……",
				"如此这般，与你四目相对。"
	...
	},
	{
		...
		dialog: {
			...
			English: [
				"But why... oh, I see.",
				"I was the one that sent you a message, wasn't I. Apologies."
			],
			Chinese: [
				"不过为何你……不，原来如此。",
				"本来就是我发出的消息。失礼了。"
	...
	},
	{
		time: 19000,
		count: 3,
		startTimes: [500, 7500, 11000],
		dialog: {
			Japanese: [
				"いや何、用事があって呼んだわけではないのだ。",
				"唯…",
				"君と交わす言葉に、私はどこか惹かれているようで。"
			],
			English: [
				"No, I didn't call you over with anything in mind.",
				"It's just...",
				"A part of me feels drawn in, by the conversation we had."
			],
			Chinese: [
				"不，并非有什么要事才请你过来。",
				"只是……",
